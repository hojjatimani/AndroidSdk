...
final class ACRAConstants {
    ...
    /**
     * Suffix to be added to handleException files when they have been approved by the
     * user in NOTIFICATION mode
     */
    public static final String APPROVED_SUFFIX = "-approved";
    /**
     * This key is used to store the silent state of a handleException sent by
     ...
     * latest generated handleException file in order to be able to associate the user
     * comment.
     */
     ...
     *
     */
    public final static ACRAReportField[] DEFAULT_MAIL_REPORT_FIELDS = { USER_COMMENT, ANDROID_VERSION, APP_VERSION_NAME,
            BRAND, PHONE_MODEL, CUSTOM_DATA, STACK_TRACE };

    /**
     * Default list of {@link ACRAReportField}s to be sent in reports. You can set
     */
    public static final ACRAReportField[] DEFAULT_REPORT_FIELDS = { REPORT_ID, APP_VERSION_CODE, APP_VERSION_NAME,
