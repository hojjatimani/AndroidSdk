 ...
 * 
 */
final class ACRADumpSysCollector {
    private static final String TAG = BefLog.TAG_PREF + "ACRADumpSysCollector";
    ...
    public static String collectMemInfo() {
        ...
        try {
            ...
            BefLog.e(TAG, "ACRADumpSysCollector.meminfo could not retrieve data", e);
		}

        ACRACollectorUtil.safeClose(bufferedReader);
