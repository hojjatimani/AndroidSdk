...
/**
 * Specifies all the different fields available in a crash handleException.
 * 
 * @author Normal
 * 
 */
enum ACRAReportField {
    /**
     * Report Identifier.
     */
    REPORT_ID,
     ...
     * the application handleException.
     */
    BUILD_CONFIG {
        @Override
        public boolean containsKeyValuePairs() {
    ...
    RADIOLOG,
    /**
     * True if the handleException has been explicitly sent silently by the developer.
     */
    IS_SILENT,
    /**
