...
/**
 * Responsible for providing base utilities used when constructing the handleException.
 * <p/>
 *
 * @author William Ferguson
 * @since 4.3.0
 */
final class ACRAReportUtils {
    private static final String TAG = BefLog.TAG_PREF+"ACRAReportUtils";
    ...
    public static String getDeviceId( Context context) {
        try {
            ...
            BefLog.w(TAG, "Couldn't retrieve DeviceId for : " + context.getPackageName(), e);
            return null;
        }
    }
    ...
    public static String getApplicationFilePath( Context context) {
        ...
        BefLog.w(TAG, "Couldn't retrieve ApplicationFilePath for : " + context.getPackageName());
